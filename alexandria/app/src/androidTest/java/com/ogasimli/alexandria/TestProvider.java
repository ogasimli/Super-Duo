...
public class TestProvider extends AndroidTestCase {
    ...
    private void readFullBook(){
        ...
        Cursor cursor = mContext.getContentResolver().query(
         ...
         com.ogasimli.alexandria.TestDb.validateCursor(cursor, com.ogasimli.alexandria.TestDb.getFullDetailValues());
    }
    ...
    private void readFullList(){
        ...
        com.ogasimli.alexandria.TestDb.validateCursor(cursor, com.ogasimli.alexandria.TestDb.getFullListValues());
    }
