...
import com.ogasimli.alexandria.data.AlexandriaDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        mContext.deleteDatabase(AlexandriaDbHelper.DATABASE_NAME);
        SQLiteDatabase db = new AlexandriaDbHelper(
    ...
    public void testInsertReadDb() {
        ...
        AlexandriaDbHelper dbHelper = new AlexandriaDbHelper(mContext);
